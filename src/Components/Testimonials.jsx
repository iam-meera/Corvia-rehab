  ...
  <div className="container">
    ...
    <div className="testimonial-grid">
      <div className="testi-card">
        ...
        <p>"The physiotherapist was punctual, professional, and helped my father recover mobility after his surgery — all from home."</p>
        <div className="who"><div className="avatar">R</div><div><h5>Ramesh K.</h5><span>Post-Surgical Care</span></div></div>
      </div>
      <div className="testi-card">
        <div className="stars">★★★★★</div>
        <p>"Excellent care for my mother's stroke recovery. The sessions were personalized and the team was incredibly patient."</p>
        <div className="who"><div className="avatar">S</div><div><h5>Sunitha M.</h5><span>Neuro Rehabilitation</span></div></div>
      </div>
      <div className="testi-card">
        <div className="stars">★★★★★</div>
        <p>"Convenient, professional, and effective. My chronic back pain has improved significantly within a few weeks."</p>
